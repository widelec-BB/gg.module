...
struct Library *SysBase, *DOSBase, *IntuitionBase, *UtilityBase, *MUIMasterBase, *LocaleBase,
					*MultimediaBase, *EzxmlBase, *OpenURLBase, *CharsetsBase;
...
{
	if(MultilogonListClass) DeleteMultilogonListClass();
	Locale_Close();
